...
android {
    namespace = "com.connectpuzzle.nexus_link"
    ...
    defaultConfig {
        // Replace this placeholder with the registered production application ID.
        applicationId = "com.connectpuzzle.nexus_link"
